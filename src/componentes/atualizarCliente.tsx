...
export default function AtualizarCliente({ tema }: Props) {
  ...
  const handleChangeDataEmissaoRG = (index: number, value: string) => {
    const novaDataEmissaoRG = [...dataEmissaoRG];
    novaDataEmissaoRG[index] = value;
    setDataEmissaoRG(novaDataEmissaoRG);
  };
        ...
        <form onSubmit={handleSubmit}>
          ...
          {rg.map((rgItem, index) => (
            <div className="input-group mb-3" key={index}>
              ...
              <button type="button" className="btn btn-outline-secondary" onClick={adicionarRG}>Adicionar RG</button>
            </div>
          ))}
          ...
          {produtosConsumidos.map((produto, index) => (
            <div className="input-group mb-3" key={index}>
              ...
              />
              <button type="button" className="btn btn-outline-secondary" onClick={adicionarProduto}>Adicionar Produto</button>
            </div>
          ))}
          ...
          {servicosConsumidos.map((servico, index) => (
            <div className="input-group mb-3" key={index}>
              ...
              />
              <button type="button" className="btn btn-outline-secondary" onClick={adicionarServico}>Adicionar Serviço</button>
            </div>
          ))}
          ...
          {pets.map((pet, index) => (
            <div className="input-group mb-3" key={index}>
              ...
              <button type="button" className="btn btn-outline-secondary" onClick={adicionarPet}>Adicionar Pet</button>
            </div>
          ))}
